...
const step10 = new Step("https://github.com/cs-internship/cs-internship-spec/blob/master/courses/web/10-IntermediateTS(II).md", "./Step 10/Step sum/Step 10 Sum.pdf", "Download", "./Step 10/Twitch/Presentation/", "https://youtu.be/ztk_81s49zE?si=PEFkZSvRBaiYEb5G", "Twitch Project", "YouTube Link");
let allSteps = [
    step0,
    step1,
    step2,
